...
##################################################################################################################
class AdvDependencyParserModel_last_mlp_multi_layered(nn.Module):
    def __init__(self, prep_word_embd, pos_vocab_size, word_emb_dim=300, pos_emb_dim=50,
                 hidden_dim=125, mlp_dim_out=100, lstm_layers=2):

        super(AdvDependencyParserModel_last_mlp_multi_layered, self).__init__()
...
##################################################################################################################
class AdvDependencyParserModel(nn.Module):
    def __init__(self, prep_word_embd, pos_vocab_size, word_emb_dim=300, pos_emb_dim=50,
                 hidden_dim=125, mlp_dim_out=100, lstm_layers=2):
